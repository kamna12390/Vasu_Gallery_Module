...
internal class CropWindowHandler {
    ...
    /** Get the left/top/right/bottom coordinates of the crop window.  *//** Set the left/top/right/bottom coordinates of the crop window.  *//** Set the left/top/right/bottom coordinates of the crop window.  */
    ...
    fun setInitialAttributeValues(options: ImageOptions) {
    ...
    private fun getRectanglePressedMoveType(
        ...
        if (isInCornerTargetZone(x, y, mEdges.left, mEdges.top, targetRadius)) {
            ...
            Log.d("TAG", "getRectanglePressedMoveType: check the crop image in if")
        } else if (isInCornerTargetZone(
                x, y, mEdges.right, mEdges.top, targetRadius
            )

        ) {
            Log.d("TAG", "getRectanglePressedMoveType: check the crop image in else if 1")
            ...
            Log.d("TAG", "getRectanglePressedMoveType: check the crop image in else if 2")
            ...
            Log.d("TAG", "getRectanglePressedMoveType: check the crop image in else if 3")
            ...
            Log.d("TAG", "getRectanglePressedMoveType: check the crop image in else if 4")
            ...
            Log.d("TAG", "getRectanglePressedMoveType: check the crop image in else if 5")
            ...
            Log.d("TAG", "getRectanglePressedMoveType: check the crop image in else if 6")
            ...
            Log.d("TAG", "getRectanglePressedMoveType: check the crop image in else if 7")
            ...
            Log.d("TAG", "getRectanglePressedMoveType: check the crop image in else if 8")
            ...
            Log.d("TAG", "getRectanglePressedMoveType: check the crop image in else if 9")
